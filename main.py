...
def add_security_headers(response):
    ...
    response.headers['Permissions-Policy']='geolocation \'none\'; microphone \'none\''
    ...
    response.headers['Content-Security-Policy']='default-src \'none\'; frame-src \'self\'; connect-src \'self\' stats.g.doubleclick.net www.google-analytics.com northamerica-northeast1-jpoirierlavoie-ca.cloudfunctions.net; img-src www.google-analytics.com www.google.ca www.google.com \'self\'; script-src-elem \'unsafe-inline\' www.google-analytics.com www.googletagmanager.com \'self\'; style-src-elem \'unsafe-inline\' \'self\'; font-src \'self\'; manifest-src \'self\'; worker-src \'self\'; report-uri https://jpoirierlavoie.report-uri.com/r/d/csp/enforce'
    return response
